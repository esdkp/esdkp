...
namespace ES_DKP_Utils
{
  ...
  public class InputBoxDialog : System.Windows.Forms.Form
  {
    ...
    private void InitializeComponent()
    {
		...
		this.txtInput.Text = "";
		this.txtInput.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.InputBoxDialog_KeyPress);
		// 
		// InputBoxDialog
		// 
		...
		this.Text = "InputBox";
		this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.InputBoxDialog_KeyPress);
    ...
    private void button1_Click(object sender, System.EventArgs e)
    {
	  ...
	  private void InputBoxDialog_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
	  {
